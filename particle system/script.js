...
class Particle {
  ...
  update() {
    ...
    if (this.x > canvas.width || this.x < 0) {
      this.directionX = -this.directionX; // If it reaches at the end of canvas, change direction
    }
    if (this.y > canvas.height || this.y < 0) {
      this.directionY = -this.directionY; // If it reaches at the end of canvas, change direction
    }

    // Check collision detection - mouse position / particle position between 2 circles mouse position and particle
